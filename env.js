...
const UI_ENV = {
    title: 'Considérations de Saint-Cyran',
    canonical: 'https://considerations.sacy.be',
    dataBasePath:'',
    uiPath: 'ui',
    ...
    links: [
        {
            ...
            url: 'https://github.com/breviaire-pr/considerations-saint-cyran/issues'
        },
        {
            title: 'code source du site web',
            url: 'https://github.com/breviaire-pr/considerations-saint-cyran'
        },
        {
